...
var GroupPave1030 = {
    "<img src='src/images/Schaerbeek-1030-ICON.png' width='20px'/><b>Pavés Mosaïques 1030</b></br>": GroupMarkersData1030_01,
};
...
function ClearMarkerData_ORIGINAL() {
    ...
    document.querySelector("#CodeID_1030").value = ""
    document.querySelector("#TilesNumber_1030").value = ""
    document.querySelector("#Status_1030").value = ""
    document.querySelector("#Artist_1030").value = ""
    document.querySelector("#Year_1030").value = ""
    document.querySelector("#Comments_1030").value = ""
    document.querySelector("#StreetFR_1030").value = ""
    document.querySelector("#HouseNumber_1030").value = ""
    document.querySelector("#Locality_1030").value = ""
    document.querySelector("#Sector_1030").value = ""
    document.querySelector("#FullAdress_1030").value = ""
    document.querySelector("#Latitude_1030").value = ""
    document.querySelector("#Longitude_1030").value = ""

    //document.querySelector("#index_0").value = ""
    //document.querySelector("#SaphirCode_0").value = ""
    //document.querySelector("#PostalCode_0").value = ""
    //document.querySelector("#Picture_0").value = ""
    //document.querySelector("#LinkPicture01_0").value = ""
    //document.querySelector("#LinkPicture02_0").value = ""
    //document.querySelector("#LinkPicture03_0").value = ""
    //document.querySelector("#PicturesNumber_0").value = ""
};

var Icon1030NEW = L.icon({
...
function addMarker(positionMarker) {
    ...
    markerReal = L.marker(
        positionMarker, { icon: Icon1030NEW }
    )
    document.querySelector("#Latitude_1030").value = positionMarker.lat;
    document.querySelector("#Longitude_1030").value = positionMarker.lng;
