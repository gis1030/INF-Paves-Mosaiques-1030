...
function SearchData() {
    ...
    //console.log(Marker1030.getLayers().length)
    //var k = 0;
    Marker1030 = L.geoJSON([ListTreesMarkers1030], {
            filter: function(feature, layer) {

                if (NumidLabel !== "ALLData") {
                    return (feature.properties.Numident === NumidLabel);
                }
                if (NumidLabel === "ALLData") {
                    if (EspeceLabel != "ALLData") {
                        //if (feature.properties.Espece === EspeceLabel) { k++ }
                        return (feature.properties.Espece === EspeceLabel);
                    }
                    if (StatutLabel != "ALLData") {
                        return (feature.properties.Statut_arbre === StatutLabel);
                    }
                    if (DangerLabel != "ALLData") {
                        return (feature.properties.Danger === DangerLabel);
                    }
                    if (StructureLabel != "ALLData") {
                        return (feature.properties.Structure === StructureLabel);
                    }
                    if (LieuPlantaLabel != "ALLData") {
                        return (feature.properties.Type_sol === LieuPlantaLabel);
                    }
                    if (TypeLieuPlantaLabel != "ALLData") {
                        return (feature.properties.Type_lieu === TypeLieuPlantaLabel);
                    }
                    if (TypeEnvirLabel != "ALLData") {
                        return (feature.properties.Environnement === TypeEnvirLabel);
                    }
                    if (TypeDistrLabel != "ALLData") {
                        return (feature.properties.Distribution === TypeDistrLabel);
                    }
                } else {
                    return true;
                }
    ...
    Marker1030_NEW = L.geoJSON([ListTreesMarkers1030_NEW], {
            filter: function(feature, layer) {
                if (NumidLabel !== "ALLData") {
                    return feature.properties.Numident === NumidLabel;
                } else {
    ...
    Marker1030_Cimetiere = L.geoJSON([ListTreesMarkers1030_Cimetiere], {
            filter: function(feature, layer) {
                if (NumidLabel !== "ALLData") {
                    return feature.properties.Numident === NumidLabel;
                } else {
